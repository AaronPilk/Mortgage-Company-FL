...
import { Card, CtaPanel, LicenseFact, Prose, Section, SectionHeading } from "@/components/ui";
    ...
    <>
      <Section width="narrow" orbs>
        ...
        <Prose>
          ...
          <p>
            ...
            and association dues are included. Ours break every component out, expose the
            assumptions, and run entirely in your browser so nothing you type is transmitted
            anywhere.
          </p>
          <p>
            We also do not publish a rate on this site. Pricing depends on credit profile,
            loan-to-value, property type, occupancy, loan amount, and lock period. A single number
            on a web page is an advertisement, not your rate, and we would rather show you real
        ...
        */}
          ...
          <p>
            ...
            though TRACT has been doing this for decades. TRACT is new. We would rather tell you
            that than pad a number.
          </p>
        ...
        <Card className="mt-10">
          ...
          <p className="mt-4 text-sm text-[var(--text-muted)]">
            ...
            record. We do not display a licence number before it exists. Verify anything you see
            here on NMLS Consumer Access.
          </p>
        </Card>
      </Section>
      ...
      <Section width="narrow" pad="tight" className="pb-16 sm:pb-24">
        <CtaPanel
          ...
          body="No application, no credit pull, no obligation. Tell us what you're working on and we'll tell you what your options actually are."
          primary={{ href: "/contact", label: "Talk to a mortgage professional", cta: "about" }}
        />
      </Section>
    </>
  );
