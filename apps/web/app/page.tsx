        ...
        <div className="container-default relative z-10 py-20 sm:py-28">
          <div className="grid items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
            <div className="max-w-3xl animate-fade-up">
              ...
              <p
                className="mt-7 max-w-2xl text-lg sm:text-xl"
              ...
              <div className="mt-9 flex flex-wrap gap-3">
                <ButtonLink href="/mortgage/plan" data-cta="hero-primary">
            ...
            >
              ...
              <div className="surface-raised absolute inset-x-4 bottom-4 rounded-2xl p-4 shadow-[var(--shadow-float)] sm:inset-x-auto sm:bottom-6 sm:left-6 sm:w-[22rem] sm:p-5">
                <div className="flex items-center justify-between gap-4">
                  <p className="text-sm font-semibold text-[var(--purple)]">TRACT Vision preview</p>
                  <span className="text-xs text-[var(--text-muted)]">Tampa fixture</span>
                </div>
                <p className="mt-1 text-xl font-bold">$635k purchase assumption</p>
                <div className="mt-3 grid grid-cols-2 gap-3 border-t border-[var(--border)] pt-3 text-xs">
                  <div>
                    <span className="block text-[var(--text-muted)]">Improvement input</span>
                    <strong className="mt-1 block text-sm">$118k</strong>
                  </div>
                  <div>
                    <span className="block text-[var(--text-muted)]">Value input</span>
                    <strong className="mt-1 block text-sm">$805k</strong>
                  </div>
                </div>
                <p className="mt-3 text-xs font-semibold text-[var(--purple)]">
                  Inspect every assumption <span aria-hidden="true">→</span>
                </p>
              </div>
            </Link>
          </div>
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          <Card className="overflow-hidden !p-0">
            ...
            <div className="p-6">
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                <ButtonLink href="/vision?property=FX-STP-0001" variant="secondary">
          ...
          <Card className="overflow-hidden !p-0">
            ...
            <div className="p-6">
              ...
              <div className="mt-6">
                <ButtonLink href="/mortgage/plan" variant="secondary">
