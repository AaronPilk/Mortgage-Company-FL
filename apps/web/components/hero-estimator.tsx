  ...
  return (
    ...
    >
      <div className="flex items-baseline justify-between gap-4">
        <h2 className="text-base font-semibold">Estimate a Florida payment</h2>
      ...
      <div className="mt-6 border-t pt-5" style={{ borderColor: "var(--border)" }}>
        ...
        >
          ...
          {formatUsd(everythingElse)} a month is tax, insurance and dues. Add condo or HOA fees
          above and watch that share fall — which is why two homes at the same price can be very
          different to carry.
        </p>
        ...
        <p className="mt-3 text-xs leading-relaxed" style={{ color: "var(--text-muted)" }}>
          ...
          actual numbers depend on the county, the property, and your coverage.
        </p>
      </div>
    </div>
  );
