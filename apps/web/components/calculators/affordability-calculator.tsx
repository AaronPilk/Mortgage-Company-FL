...
export function AffordabilityCalculator() {
  ...
  return (
    <>
      ...
      <ScenarioActions
        intent="purchase"
        compareTargetId="aff-income"
        snapshot={{
          source: "affordability",
          version: "affordability-calculator@1.0.0",
          calculationVersion: result.calculationVersion,
          inputSnapshot: {
            grossMonthlyIncomeDollars: monthlyIncome,
            monthlyDebtDollars: monthlyDebts,
          ...
          resultSnapshot: {
            estimatedPurchasePriceDollars: Math.round(result.estimatedPurchasePriceCents / 100),
            estimatedMonthlyHousingDollars: Math.round(
              result.housingBreakdown.totalMonthlyCents / 100
            ),
            bindingConstraint: result.bindingConstraint
          },
          summary: `${formatUsd(result.estimatedPurchasePriceCents)} illustrative purchase range · ${formatUsd(result.housingBreakdown.totalMonthlyCents)} estimated monthly housing`
        }}
      />
    </>
  );
